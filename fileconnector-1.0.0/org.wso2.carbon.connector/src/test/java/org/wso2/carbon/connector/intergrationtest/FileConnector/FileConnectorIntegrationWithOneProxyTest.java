...
//
    ...
    /**
     *Positive test case for read the content inside zip file method with mandatory parameters.
     */
//
//    @Test(groups = { "wso2.esb" }, description = "Fileconnector read content inside zip file intergration test")
//    public void testReadContentInZipFile() throws Exception {
//
//        esbRequestHeadersMap.put("Action", "urn:readContent");
//        RestResponse<OMElement> esbRestResponse =
//                sendXmlRestRequest(proxyUrl, "POST",
//                        esbRequestHeadersMap);
//
...
//    }
    ...
    /**
     *Positive test case for add a file into zip file method with mandatory parameters.
     */
//
//    @Test(groups = { "wso2.esb" }, description = "Fileconnector add a file into zip file intergration test")
//    public void testAddFie() throws Exception {
//
//        esbRequestHeadersMap.put("Action", "urn:addFiles");
//        RestResponse<OMElement> esbRestResponse =
//                sendXmlRestRequest(proxyUrl, "POST",
//                        esbRequestHeadersMap);
//
